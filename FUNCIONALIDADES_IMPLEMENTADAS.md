...
- `database-updates-v2.sql` - Migración de base de datos
...
- `database-updates-v2.sql` - Tabla `coupons`
...
- `database-updates-v2.sql` - Tabla `reviews`
...
Ejecutar `database-updates-v2.sql` para:
